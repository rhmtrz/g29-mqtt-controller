...
class Controller:
    ...
    def __init__(self, id, dead_zone = 0.15):
        ...
        self._parser.read('g29_config.ini')
        self._steer_idx     = int(self._parser.get('G29 Controller', 'steering_wheel'))
        self._clutch_idx  = int(self._parser.get('G29 Controller', 'gear'))
        self._throttle_idx = int(self._parser.get('G29 Controller', 'throttle'))
        self._brake_idx     = int(self._parser.get('G29 Controller', 'brake'))
        self._reverse_idx   = int(self._parser.get('G29 Controller', 'reverse'))
        self._handbrake_idx = int(self._parser.get('G29 Controller', 'handbrake'))
